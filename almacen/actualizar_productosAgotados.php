...
<body>
		<div>
			<form action="querys/update_productosAgotados.php" method="POST" enctype="multipart/form-data">
				...
				<input type="text" name="precio" maxlength="5" value="<?php echo $row['precio']?>" readonly><br><br>
